...
<body  id="page-top" >
    ...
    <table>
        <tr>
            ...
            <th>Rol</th><th>Estado</th><th>Fecha Creación</th><th>Acciones</th>
        </tr>
        <%
        ...
        <tr>
            ...
            <td>
                <a href="controlUsuario?accion=editar&id=<%=u.getIdUsuario()%>">Editar</a>
                <a href="controlUsuario?accion=eliminar&id=<%=u.getIdUsuario()%>" 
